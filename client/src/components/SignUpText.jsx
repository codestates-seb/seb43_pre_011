...
export const SignUpText = () => {
  return (
    <TextStyle>
      <h3 className="title">Join the Stack Overflow community</h3>
      <div className="list">
        ...
        <div className="text">Get unstuck — ask a question</div>
      </div>
      <div className="list">
        <svg width="26" height="26" className="icon">
      ...
      <div className="list">
        ...
        <div className="text">Earn reputation and badges</div>
      </div>
      <div className="text">
